...
export function atomsToSplats(atoms, options = {}) {
    const { colorMode = "element", radiusScale = 0.5, opacity = 0.9, includeHydrogens = false, customColorFn, } = options;
...
// ============ Molecule (SDF) → Splat ============
export function moleculeToSplats(mol, options = {}) {
    const { radiusScale = 0.5, opacity = 0.9, } = options;
...
export function bondsToSplats(atoms, bonds, splatsPerBond = 8, radius = 0.15, opacity = 0.7) {
...
export function generateSurfaceSplats(atoms, options = {}) {
    const { resolution = 20, probe = 1.4, opacity = 0.3, scale = 0.3, } = options;
...
export function highlightPocket(splatData, options) {
...
//# sourceMappingURL=atom-to-splat.js.map